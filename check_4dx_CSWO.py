...
def check_shows() -> tuple:
    ...
    try:
        ...
        # Extract show times, screens, formats
        ...
        # Check for 4DX specifically
        block_lower = block.lower()
        is_4dx = "4dx" in block_lower

        if times and is_4dx:
            print(f"   ✅ {FORMAT} shows confirmed at {CINEMA_NAME}!")
            return True, times
        elif times and not is_4dx:
            print(f"   ⚠️  Shows exist but NOT 4DX format — not alerting")
        else:
